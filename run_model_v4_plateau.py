...
from models.callbacks import VAE_SaveModelCallback, SaveModelCallback, WriteHistSummaryCallback, ScheduleLRCallback, LR_Reduce_On_Plateau, VAE_PlateauScheduleLRCallback
...
def main():
    ...
    if args.prediction_only:
        ...
        """
        schedule_lr = VAE_PlateauScheduleLRCallback(
            model,
            writer=writer_val,
            func=LR_Reduce_On_Plateau(config['lr'], 
                                      factor=config['lr_schedule_rate'], 
